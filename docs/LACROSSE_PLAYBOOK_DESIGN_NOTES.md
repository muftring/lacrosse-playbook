...
- **Planned — Draw Sim steps 5–6.** Probabilistic contest resolution + outcome log; minimal stats capture for draw runs.
...
- [x] Draw Sim step 4: circle/wing attributes + reaction state machine — branch `sim/draw-circle-players`, PR pending
